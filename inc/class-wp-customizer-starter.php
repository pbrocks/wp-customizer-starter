...
class Customizing_with_the_Customizer {
	...
	private function simple_section( $wp_manager ) {
		$wp_manager->add_section( 'simple_customizer_section', array(
	...
	private function complex_section( $wp_manager ) {
		$wp_manager->add_section( 'complex_customizer_section', array(
	...
	private function advanced_sections( $wp_manager ) {
		$wp_manager->add_section( 'advanced_controls_section', array(
		 ...
		 * Adding Date Picker
		 */
		require_once dirname( __FILE__ ) . '/controls/date/date-picker-custom-control.php';
		 ...
		 */
		require_once dirname( __FILE__ ) . '/controls/layout/layout-picker-custom-control.php';
		 ...
		 */
		require_once dirname( __FILE__ ) . '/controls/select/category-dropdown-custom-control.php';
		 ...
		 */
		require_once dirname( __FILE__ ) . '/controls/select/menu-dropdown-custom-control.php';
		 ...
		 */
		require_once dirname( __FILE__ ) . '/controls/select/post-dropdown-custom-control.php';
		 ...
		 */
		require_once dirname( __FILE__ ) . '/controls/select/post-type-dropdown-custom-control.php';
		 ...
		 */
		require_once dirname( __FILE__ ) . '/controls/select/tags-dropdown-custom-control.php';
		 ...
		 */
		require_once dirname( __FILE__ ) . '/controls/select/taxonomy-dropdown-custom-control.php';
		 ...
		 */
		require_once dirname( __FILE__ ) . '/controls/select/user-dropdown-custom-control.php';
		 ...
		 */
		require_once dirname( __FILE__ ) . '/controls/text/textarea-custom-control.php';
		 ...
		 */
		require_once dirname( __FILE__ ) . '/controls/text/text-editor-custom-control.php';
